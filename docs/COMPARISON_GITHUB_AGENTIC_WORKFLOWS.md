# Comparison: Workflow Runner vs GitHub Agentic Workflows

This document compares our **Workflow Runner** project with **GitHub Agentic Workflows** (gh-aw), a product developed by GitHub Next and Microsoft Research.
...
| Aspect | Workflow Runner | GitHub Agentic Workflows |
|--------|-----------------|--------------------------|
...
**Key Insight:** GitHub Agentic Workflows is a specialized tool for GitHub repository automation. Workflow Runner is a universal orchestration engine that can automate *anything* — software development is just one of many possible applications.
...
Workflow Runner is a **general-purpose, platform-agnostic AI workflow orchestration engine**. It uses YAML-defined Directed Acyclic Graphs (DAGs) to coordinate multiple AI agents through complex, parallel, and conditional workflows.
...
| GitHub Agentic Workflows | Workflow Runner |
|--------------------------|-----------------|
...
**Workflow Runner is not a "software development tool" — it is a universal workflow engine.** The fact that the initial examples focus on code review is incidental. The same engine can orchestrate:
...
**This is a fundamental architectural difference.** GitHub Agentic Workflows is a feature *of* GitHub. Workflow Runner is an independent tool that can be integrated *with* GitHub, GitLab, Jenkins, Azure Pipelines, Buildkite, or run standalone.
...
**Example:** A complex code review pipeline in Workflow Runner:
```yaml
steps:
  - id: security-scan
...
**Workflow Runner + MCP = Universal Automation:**
...
However, **the overlap is narrow**. GitHub Agentic Workflows is a feature for GitHub users who want simple, natural-language automation of repository tasks. Workflow Runner is a general-purpose engine for anyone who needs to orchestrate complex, multi-agent workflows across any domain or platform.

**They can coexist:** A team might use GitHub Agentic Workflows for simple daily triage inside GitHub, while using Workflow Runner for complex cross-system pipelines that span GitHub, Jira, Slack, and internal databases.

---

## Conclusion

Workflow Runner is not competing with GitHub Agentic Workflows — it operates at a different level of abstraction and serves a broader audience.

**GitHub Agentic Workflows** = "Easy AI automation for GitHub repositories"

**Workflow Runner** = "Universal AI workflow orchestration for any domain, any platform, any system"

The platform independence, explicit DAG orchestration, and MCP integration make Workflow Runner suitable for use cases that GitHub Agentic Workflows cannot address, including non-software domains like business operations, data pipelines, team communication analysis, and personal automation.
